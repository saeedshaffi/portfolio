...
function home(){return `<section class="home-hero reveal" aria-labelledby="home-hero-title"><div class="home-hero-meta"><span>Berlin · Lead Product Designer</span><span>Fintech · eCommerce · B2B · B2C · SaaS</span></div><div class="home-hero-content"><h1 id="home-hero-title">I turn complex problems into products that move metrics. <a class="home-inline-cta" href="#/" data-scroll-target="selected-work" aria-label="See my work"><span class="home-inline-label">See my work</span><span class="home-eye" aria-hidden="true"></span></a> 10+ years designing for<br aria-hidden="true" /><em class="home-rotating-phrase"><span class="home-rotating-group" aria-hidden="true"><span class="home-rotating-word"><span style="--word-index:0">impact</span><span style="--word-index:1">growth</span><span style="--word-index:2">results</span></span></span><span class="sr-only">impact</span></em><br /><a class="home-talk-pill" href="mailto:saeedshaffi@gmail.com"><span>Let’s talk</span><i class="home-talk-icon" aria-hidden="true">↗</i></a> about joining your team.</h1><div class="home-hero-note"><p>More than 10 years combining research, product strategy, systems thinking, and craft. From early ideas to measurable results.</p><a class="home-resume-link" href="assets/SaeedShaffi_Resume.pdf" download="SaeedShaffi_Resume.pdf" aria-label="Open Saeed Shaffi résumé PDF">View résumé <span aria-hidden="true">↗</span></a></div></div></section><section class="page section home-work" id="selected-work" tabindex="-1"><div class="section-head"><div><span class="eyebrow">Selected work</span><h2>Designed to move<br>the metric.</h2></div><p>Five stories about research, systems thinking, stakeholder alignment and measurable product impact.</p></div><div class="project-grid">${projectCards()}</div><section class="home-archive" aria-labelledby="visual-archive-title"><div class="section-head"><div><span class="eyebrow">Visual archive</span><h2 id="visual-archive-title">Selected shots</h2></div></div><div class="shots">${shots.map(([n,u])=>`<button class="shot" type="button" data-shot-src="${SHOTS_FULL+u}" data-shot-title="${n}" aria-label="Open ${n} interface preview" aria-haspopup="dialog"><img loading="lazy" src="${SHOTS+u}" alt="${n} interface preview"><span>${n}</span></button>`).join('')}</div></section></section>${careerTimeline()}`}
...
function initHomeRotatingWords(){
  ...
  const fit = (track, word) => {
    /* Let the slot follow the visible word so shorter words do not leave a
       large empty gap before the sentence continues. */
