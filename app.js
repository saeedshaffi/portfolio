...
function home(){return `<section class="home-hero reveal" aria-labelledby="home-hero-title"><div class="home-hero-meta"><span>Berlin · Lead Product Designer</span><span>Fintech · eCommerce · B2B · B2C · SaaS</span></div><div class="home-hero-content"><h1 id="home-hero-title">I design clarity into products where <br class="home-hero-break" aria-hidden="true" /><em class="home-rotating-phrase"><span class="home-rotating-group" aria-hidden="true"><span class="home-rotating-word"><span style="--word-index:0">complexity</span><span style="--word-index:1">data</span><span style="--word-index:2">systems</span><span style="--word-index:3">AI</span><span style="--word-index:4">decisions</span></span><span class="home-rotating-tail"> and</span></span><br class="home-suffix-break" aria-hidden="true" /> <span class="home-rotating-suffix" aria-hidden="true">business collide.</span><span class="sr-only">complexity and business collide.</span></em><br /><a class="home-talk-pill" href="mailto:saeedshaffi@gmail.com"><span>Let’s talk</span><i class="home-talk-icon" aria-hidden="true">↗</i></a> about your product. <a class="home-inline-cta" href="#/" data-scroll-target="selected-work" aria-label="View selected work"><span class="home-inline-label">As you can see</span><span class="home-eye" aria-hidden="true"></span></a></h1><div class="home-hero-note"><p>More than 10 years combining research, product strategy, systems thinking and craft, from early ideas through launch and measurable results.</p><a class="home-resume-link" href="assets/SaeedShaffi_Resume.pdf" download="SaeedShaffi_Resume.pdf" aria-label="Open Saeed Shaffi résumé PDF">View résumé <span aria-hidden="true">↗</span></a></div></div></section><section class="page section home-work" id="selected-work" tabindex="-1"><div class="section-head"><div><span class="eyebrow">Selected work</span><h2>Designed to move<br>the metric.</h2></div><p>Five stories about research, systems thinking, stakeholder alignment and measurable product impact.</p></div><div class="project-grid">${projectCards()}</div><section class="home-archive" aria-labelledby="visual-archive-title"><div class="section-head"><div><span class="eyebrow">Visual archive</span><h2 id="visual-archive-title">Selected shots</h2></div></div><div class="shots">${shots.map(([n,u])=>`<button class="shot" type="button" data-shot-src="${SHOTS_FULL+u}" data-shot-title="${n}" aria-label="Open ${n} interface preview" aria-haspopup="dialog"><img loading="lazy" src="${SHOTS+u}" alt="${n} interface preview"><span>${n}</span></button>`).join('')}</div></section></section>${careerTimeline()}`}
