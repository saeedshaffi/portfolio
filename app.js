...
function initDraggableContactCard(){
  ...
  card.innerHTML=`<div class="drag-contact-head"><span class="drag-contact-avatar"><img src="assets/saeed-avatar.png" alt=""></span><span><b>Saeed Shaffi</b><small>Product Designer</small></span><span class="drag-contact-hint" aria-hidden="true"><i></i> Drag me</span></div><p>Have a complex product?<br><strong>Let’s make it feel simple.</strong></p><a class="drag-contact-cta" href="mailto:saedshaffi@gmail.com"><span>Let’s talk</span><span aria-hidden="true">↗</span></a>`;
