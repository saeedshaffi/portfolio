...
function renderRoute(){
  ...
  if(path==='/about'||path==='/resume-old'||path==='/resume'){
    (function(){const a=document.createElement('a');a.href='assets/SaeedShaffi_Resume.pdf?v=deel';a.download='SaeedShaffi_Resume.pdf';document.body.appendChild(a);a.click();a.remove();})();
